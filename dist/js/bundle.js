...
function binary_to_base64(e) {
  for (var t = new Uint8Array(e), r = new Array(), n = 0, i = 0, a = new Array(3), o = new Array(4), s = t.length, d = 0; s--;) {
    if (a[n++] = t[d++], 3 == n) {
      for (o[0] = (252 & a[0]) >> 2, o[1] = ((3 & a[0]) << 4) + ((240 & a[1]) >> 4), o[2] = ((15 & a[1]) << 2) + ((192 & a[2]) >> 6), o[3] = 63 & a[2], n = 0; n < 4; n++) {
  ...
  if (n) {
    ...
    for (o[0] = (252 & a[0]) >> 2, o[1] = ((3 & a[0]) << 4) + ((240 & a[1]) >> 4), o[2] = ((15 & a[1]) << 2) + ((192 & a[2]) >> 6), o[3] = 63 & a[2], i = 0; i < n + 1; i++) {
...
function base64_decode(e) {
  ...
  for (var u = 0; c < e.length;) {
    i = keyStr.indexOf(e.charAt(c++)), a = keyStr.indexOf(e.charAt(c++)), o = keyStr.indexOf(e.charAt(c++)), s = keyStr.indexOf(e.charAt(c++)), t = i << 2 | a >> 4, r = (15 & a) << 4 | o >> 2, n = (3 & o) << 6 | s, d[u++] = t, 64 != o && (d[u++] = r), 64 != s && (d[u++] = n);
  }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(312)))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(297)(module)))
...
module.exports = !__webpack_require__(88) && !__webpack_require__(122)(function () {
  return Object.defineProperty(__webpack_require__(307)('div'), 'a', {
    get: function get() {
      return 7;
    }
  }).a != 7;
...
/* harmony import */ var celerxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48);
/* harmony import */ var celerxjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(celerxjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var seed_random__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(89);
...
var Core = new function () {
  ...
  this.init = function () {
    var match = celerxjs__WEBPACK_IMPORTED_MODULE_0___default.a.getMatch();
    seed_random__WEBPACK_IMPORTED_MODULE_1___default()(match && match.sharedRandomSeed, {
      global: true
    });
    celerxjs__WEBPACK_IMPORTED_MODULE_0___default.a.start();
  ...
  function gameOver() {
    ...
    celerxjs__WEBPACK_IMPORTED_MODULE_0___default.a.submitScore(score);
...
Core.init();
console.log(celerxjs__WEBPACK_IMPORTED_MODULE_0___default.a);
console.log(seed_random__WEBPACK_IMPORTED_MODULE_1___default.a);
